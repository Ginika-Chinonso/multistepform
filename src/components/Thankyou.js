...
const Thankyou = () => {
    return (
        <div className="flex flex-col m-5 p-3 border rounded-lg text-center md:border-none md:bg-transparent">
            <img className="self-center" src={thankyou} alt='Thank you' />
