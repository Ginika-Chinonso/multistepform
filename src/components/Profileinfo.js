        ...
        <div className="mx-auto p-3 border rounded-lg md:border-none md:bg-transparent">
            ...
            <form className="flex flex-col gap-3">
                <label className="">
                    ...
                    <input type='text' className="border p-2 rounded-lg w-full active" placeholder='e.g. Stephen King' onChange={(e) => {
                        setUser({...user, 'Name': e.target.value})
                    }} />
                </label>
                <label>
                    <span className="block">Email Address</span>
                    <input type='text' className="border p-2 rounded-lg w-full active" placeholder='e.g. stephenking@lorem.com' onChange={(e) => {
                        setUser({...user, 'Email': e.target.value})
                    }}/>
                </label>
                <label>
                    <span className="block">Phone Number</span>
                    <input type='text' className="border p-2 rounded-lg w-full active" placeholder='e.g. +1 234 567 890' onChange={(e) => {
