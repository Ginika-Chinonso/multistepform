...
const Addons  = () => {
    ...
    const [addonPlan, setAddonPlan] = useState('monthly')
    return (
        <div className="mx-auto p-3 border rounded-lg md:border-none md:bg-transparent">
            ...
            <section>
                <div className="flex gap-3 border p-3 rounded-lg my-5 active">
                    ...
                    <p className="text-purplish-blue">+${(addonPlan === 'monthly') ? AddonPlans.monthly.onlineService : AddonPlans.yearly.onlineService}/{(addonPlan === 'monthly') ? 'mo' : 'yr'}</p>
                </div>
                <div className="flex gap-3 border p-3 rounded-lg my-5 active">
                    <input type='checkbox' />
                    ...
                    <p className="text-purplish-blue">+${(addonPlan === 'monthly') ? AddonPlans.monthly.largerStorage : AddonPlans.yearly.largerStorage}/{(addonPlan === 'monthly') ? 'mo' : 'yr'}</p>
                </div>
                <div className="flex gap-3 border p-3 rounded-lg my-5 active">
                    <input type='checkbox' />
                    ...
                    <p className="text-purplish-blue">+${(addonPlan === 'monthly') ? AddonPlans.monthly.customizableProfit : AddonPlans.yearly.customizableProfit}/{(addonPlan === 'monthly') ? 'mo' : 'yr'}</p>
                </div>
            </section>
